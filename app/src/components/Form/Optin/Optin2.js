...
import { addSubscription2 } from '../../../firebase'; // Adjust the import path based on your project structure
import './Optin.scss';

const Optin2 = ({ onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Use the addSubscription2 function from firebase.js
      await addSubscription2(email);
